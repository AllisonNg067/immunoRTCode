...
file_name = 'new RT ' + str(RT_fractions) + ' PD ' + str(PD_fractions) + ' CTLA4 ' + str(CTLA4_fractions) + ' ' + str(initial_cell_count) + ' d.csv'
...
#     print('k', k)
#     print(params[k])
args = [(k, params) for k in range(2400, min(iterations,3200))]
